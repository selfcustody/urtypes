...
class HDKey(RegistryItem):
	...
	def __eq__(self, o):
		return (
			self.master == o.master and
			self.key == o.key and
			self.chain_code == o.chain_code and
			self.private_key == o.private_key and
			self.use_info == o.use_info and
			self.origin == o.origin and
			self.children == o.children and
			self.parent_fingerprint == o.parent_fingerprint and
